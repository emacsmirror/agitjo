...
[[https://packages.guix.gnu.org/packages/emacs-agitjo][file:https://packages.guix.gnu.org/packages/emacs-agitjo/badges/latest-version.svg]] [[https://melpa.org/#/agitjo][file:https://melpa.org/packages/agitjo-badge.svg]] [[https://stable.melpa.org/#/agitjo][file:https://stable.melpa.org/packages/agitjo-badge.svg]]

*** Guix

AGitjo is available as a [[https://guix.gnu.org/][GNU Guix]] package.
...
AGitjo is also available on [[https://melpa.org/#/agitjo][MELPA]] and [[https://stable.melpa.org/#/agitjo][MELPA Stable]].  See [[https://melpa.org/#/getting-started][Getting Started]] for
instructions on using the MELPA repositories.
